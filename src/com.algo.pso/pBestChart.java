...
public class pBestChart extends ApplicationFrame {

    private static final String TITLE = "Particle Travelling Distance";
    private static final String START = "Start";
    private static final String STOP = "Stop";
    private static final float MINMAX = 1000000;
    ...
    public pBestChart(final String title) {
        super(title);
...
//            System.out.println("Value of fitness for swarm"+i+"is "+fitnessValueList[i]);
    ...
    private JFreeChart createChart(final XYDataset dataset) {
        final JFreeChart result = ChartFactory.createTimeSeriesChart(
                TITLE, "Time", "pBest", dataset, true, true, false);
        final XYPlot plot = result.getXYPlot();
        ValueAxis domain = plot.getDomainAxis();
        domain.setAutoRange(true);
        ValueAxis range = plot.getRangeAxis();
        range.setRange(-MINMAX, 20000);
        return result;
    }
    ...
    public static void main(final String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                pBestChart demo = new pBestChart(TITLE);
                demo.pack();
